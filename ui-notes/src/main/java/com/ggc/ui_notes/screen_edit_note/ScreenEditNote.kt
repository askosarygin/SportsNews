...
import com.ggc.common.R.string.edit
import com.ggc.common.R.string.edit_note
...
//        Column {
//            TopBarBackButton(
//                headerName = stringResource(id = edit_note),
    ...
    Column {
        ...
        Column(
            ...
            Row(
                ...
                ScreenNotesButton(
                    modifier = Modifier.weight(weight = 1f),
                    text = stringResource(id = edit),
                    onClick = { viewModel.buttonEditPressed() }
                )
                ScreenNotesButton(
                    modifier = Modifier.weight(weight = 1f),
